class Itensor < Formula
  ...
  def install
    ...
    platform = "mkl"
    mkl_dir = Formula["mkl"].opt_prefix
    blas_lapack_libflags = "-L#{mkl_dir}/lib -lmkl_rt -liomp5 -lpthread"
    blas_lapack_includeflags = "-I#{mkl_dir}/include"
  ...
  test do
    mkl_dir = Formula["mkl"].opt_prefix
    blas_lapack_flags = ["-I#{mkl_dir}/include", "-L#{mkl_dir}/lib", "-lmkl_rt", "-liomp5", "-lpthread"]
